package com.mycompany.clientesagenda;
...
public class ClientesAgenda {
    ...
    public static void main(String[] args) {
            ...
            {
                System.out.println("......................");
                System.out.println("AGENDA CLIENTES");
                System.out.println("......................");
                System.out.println("1-Nuevo contacto Cliente");
                System.out.println("2-Buscar contacto Cliente");
                System.out.println("3-Modificar contacto Cliente");
                System.out.println("4-Eliminar contacto Cliente");
                System.out.println("5-Listado de contactos Clientes");
                System.out.println("6-Vaciar agenda Clientes");
    ...
    public static boolean esNumerica(String str)
{
    ...
    private static class Agenda {
        ...
        private void Anadir(String nombre, int telefono_entero) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private void Consultar(String nombre, int telefono_entero) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }
}
